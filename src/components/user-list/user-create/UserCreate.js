...
const changeHandler = (e) => {
    setValues(state => ({
        ...state,
        [e.target.name]: e.target.value //  [e.target.name] - dinamic property in Object
    }));
};
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <input id="email" name="email" type="text" value={values.email} onChange={changeHandler} onBlur={(e) => minLength(e, 5)} />
                            </div>
                            {errors.email &&
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <input id="phoneNumber" name="phoneNumber" type="text" value={values.phoneNumber} onChange={changeHandler} onBlur={(e) => minLength(e, 6)} />
                            </div>
                            {errors.phoneNumber &&
                    ...
                    <div className="form-group long-line">
                        ...
                        <div className="input-wrapper">
                            ...
                            <input id="imageUrl" name="imageUrl" type="text" value={values.imageUrl} onChange={changeHandler} onBlur={(e) => minLength(e, 3)} />
                        </div>
                        {errors.imageUrl &&
